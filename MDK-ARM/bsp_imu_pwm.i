# 1 "../User/Bsp/bsp_imu_pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/bsp_imu_pwm.c" 2
...
# 5 "../User/Bsp/inc\\bsp_imu_pwm.h" 2

void SPI1_imu_pwm_set(uint16_t pwm);
# 2 "../User/Bsp/bsp_imu_pwm.c" 2

void SPI1_imu_pwm_set(uint16_t pwm)
{
    ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x4400UL))->CCR1 = (pwm);
}
