...
void MX_ADC1_Init(void)
{
  ...
  hadc1.Instance = ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL));
  hadc1.Init.ClockPrescaler = ((uint32_t)(0x1UL << (16U)));
  ...
  sConfig.Channel = ((uint32_t)((uint32_t)(0x10UL << (0U))));
  sConfig.Rank = 1;
...
void MX_ADC3_Init(void)
{
  ...
  hadc3.Instance = ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL));
  hadc3.Init.ClockPrescaler = ((uint32_t)(0x1UL << (16U)));
  hadc3.Init.Resolution = 0x00000000U;
  hadc3.Init.ScanConvMode = DISABLE;
  hadc3.Init.ContinuousConvMode = DISABLE;
  hadc3.Init.DiscontinuousConvMode = DISABLE;
  hadc3.Init.ExternalTrigConvEdge = 0x00000000U;
  hadc3.Init.ExternalTrigConv = ((uint32_t)(0xFUL << (24U)) + 1U);
  hadc3.Init.DataAlign = 0x00000000U;
  hadc3.Init.NbrOfConversion = 1;
  hadc3.Init.DMAContinuousRequests = DISABLE;
  hadc3.Init.EOCSelection = 0x00000001U;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  if(adcHandle->Instance==((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL)))
  {
  ...
  else if(adcHandle->Instance==((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL)))
  {




    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (10U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (10U)))); (void)tmpreg; } while(0U);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  else if(adcHandle->Instance==((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~((0x1UL << (10U))));




    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0400));
