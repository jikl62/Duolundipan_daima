...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c" 2
...
# 388 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 827 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
  ...
  else
  {
    if ((hspi->Init.Mode == (0x00000000U)) || (initial_TxXferCount == 0x01U))
    {
      *((volatile uint8_t *)&hspi->Instance->DR) = *((const uint8_t *)hspi->pTxBuffPtr);
                                          ...
                                          uint16_t Size, uint32_t Timeout)
{
  ...
  if (!((tmp_state == HAL_SPI_STATE_READY) || ((tmp_mode == ((0x1UL << (2U)) | (0x1UL << (8U)))) && (hspi->Init.Direction == (0x00000000U)) &&
...
# 1208 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
  ...
  if (hspi->Init.DataSize == (0x1UL << (11U)))
  {
    if ((hspi->Init.Mode == (0x00000000U)) || (initial_TxXferCount == 0x01U))
    {
      ...
      hspi->pTxBuffPtr += sizeof(uint16_t);
      hspi->TxXferCount--;
# 1231 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
    }
...
# 1355 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
  if (SPI_EndRxTxTransaction(hspi, Timeout, tickstart) != HAL_OK)
  {
    hspi->ErrorCode = (0x00000020U);
    do{ (hspi)->Lock = HAL_UNLOCKED; }while (0U);
...
# 1473 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Receive_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
...
# 1629 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
  if ((hspi->Instance->CR1 & (0x1UL << (6U))) != (0x1UL << (6U)))
  {
...
# 1651 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_Transmit_DMA(SPI_HandleTypeDef *hspi, const uint8_t *pData, uint16_t Size)
{
...
# 1865 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
HAL_StatusTypeDef HAL_SPI_TransmitReceive_DMA(SPI_HandleTypeDef *hspi, const uint8_t *pTxData, uint8_t *pRxData,
                                              uint16_t Size)
{
  uint32_t tmp_mode;
  ...
  if (!((tmp_state == HAL_SPI_STATE_READY) ||
        ((tmp_mode == ((0x1UL << (2U)) | (0x1UL << (8U)))) && (hspi->Init.Direction == (0x00000000U)) &&
         (tmp_state == HAL_SPI_STATE_BUSY_RX))))
  {
    return HAL_BUSY;
  }
...
# 3201 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_2linesTxISR_8BIT(struct __SPI_HandleTypeDef *hspi)
{
  *(volatile uint8_t *)&hspi->Instance->DR = *((const uint8_t *)hspi->pTxBuffPtr);
  hspi->pTxBuffPtr++;
...
static void SPI_2linesRxISR_16BIT(struct __SPI_HandleTypeDef *hspi)
{
  ...
  *((uint16_t *)hspi->pRxBuffPtr) = (uint16_t)(hspi->Instance->DR);
  ...
  if (hspi->RxXferCount == 0U)
  {
# 3255 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
...
# 3293 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_2linesTxISR_16BIT(struct __SPI_HandleTypeDef *hspi)
{
...
# 3353 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_RxISR_8BIT(struct __SPI_HandleTypeDef *hspi)
{
  *hspi->pRxBuffPtr = (*(volatile uint8_t *)&hspi->Instance->DR);
  hspi->pRxBuffPtr++;
  hspi->RxXferCount--;
# 3367 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
  if (hspi->RxXferCount == 0U)
  {
...
# 3409 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static void SPI_RxISR_16BIT(struct __SPI_HandleTypeDef *hspi)
{
  *((uint16_t *)hspi->pRxBuffPtr) = (uint16_t)(hspi->Instance->DR);
  hspi->pRxBuffPtr += sizeof(uint16_t);
  hspi->RxXferCount--;
# 3423 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
  if (hspi->RxXferCount == 0U)
  {
...
# 3617 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
static HAL_StatusTypeDef SPI_EndRxTxTransaction(SPI_HandleTypeDef *hspi, uint32_t Timeout, uint32_t Tickstart)
{
  volatile uint32_t count;


  if (SPI_WaitFlagStateUntilTimeout(hspi, (0x1UL << (1U)), SET, Timeout, Tickstart) != HAL_OK)
  {
    ((hspi->ErrorCode) |= ((0x00000020U)));
    return HAL_TIMEOUT;
  }
  ...
  count = 1000U * (SystemCoreClock / 24U / 1000000U);
...
# 3717 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_spi.c"
    if (hspi->ErrorCode == (0x00000000U))
    {
      if (hspi->State == HAL_SPI_STATE_BUSY_RX)
      {
