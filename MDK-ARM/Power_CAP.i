# 1 "../User/Bsp/Power_CAP.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/Power_CAP.c" 2
...
# 5 "../User/Bsp/inc\\Power_CAP.h" 2
# 1 "../User/Start/Inc\\MY_Define.h" 1
# 6 "../User/Bsp/inc\\Power_CAP.h" 2
...
void Power_CAP_CAN_RX(CAPDATE_TYPDEF *CAP_DATA, uint8_t *DATA)
{
    ...
    CAP_DATA->GET.ONLINE_JUDGE_TIME = 15;
}
