...
# 9 "../User/UI/ui_interface.h" 2
# 1 "../User/UI/ui_types.h" 1
# 12 "../User/UI/ui_types.h"
...
# 27 "../User/Algorithm/inc/kalman_filter.h"
...
void _ui_init_g_Ungroup_0() {
    ...
    HAL_UART_Transmit_DMA(&huart6, (uint8_t *) &ui_g_Ungroup_0, sizeof(ui_g_Ungroup_0));osDelay(34);;
}
...
void _ui_init_g_Ungroup_1() {
    ...
    HAL_UART_Transmit_DMA(&huart6, (uint8_t *) &ui_g_Ungroup_1, sizeof(ui_g_Ungroup_1));osDelay(34);;
}
...
void _ui_init_g_Ungroup_2() {
    ...
    HAL_UART_Transmit_DMA(&huart6, (uint8_t *) &ui_g_Ungroup_2, sizeof(ui_g_Ungroup_2));osDelay(34);;
}
...
void _ui_init_g_Ungroup_3() {
    ...
    HAL_UART_Transmit_DMA(&huart6, (uint8_t *) &ui_g_Ungroup_3, sizeof(ui_g_Ungroup_3));osDelay(34);;
}
...
void _ui_init_g_UngroupNUM_0() {
    ...
    HAL_UART_Transmit_DMA(&huart6, (uint8_t *) &ui_g_UngroupNUM_0, sizeof(ui_g_UngroupNUM_0));osDelay(34);;
}
