# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
# 29 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c"
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_f32.c" 1
# 29 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_f32.c"
# 1 "../Middlewares/CMSIS/DSP/Inc\\dsp/controller_functions.h" 1
# 30 "../Middlewares/CMSIS/DSP/Inc\\dsp/controller_functions.h"
...
# 31 "../Middlewares/CMSIS/DSP/Inc\\dsp/controller_functions.h" 2
...
# 32 "../Middlewares/CMSIS/DSP/Inc\\dsp/controller_functions.h" 2
...
# 34 "../Middlewares/CMSIS/DSP/Inc\\dsp/controller_functions.h" 2
...
# 35 "../Middlewares/CMSIS/DSP/Inc\\dsp/controller_functions.h" 2
...
# 30 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_f32.c" 2
# 51 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_f32.c"
void arm_pid_init_f32(
  arm_pid_instance_f32 * S,
  int32_t resetStateFlag)
{
...
# 30 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_q15.c" 1
# 51 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_q15.c"
void arm_pid_init_q15(
  arm_pid_instance_q15 * S,
  int32_t resetStateFlag)
{
  ...
  S->A0 = __builtin_arm_qadd16(__builtin_arm_qadd16(S->Kp, S->Ki), S->Kd);




  S->A1 = ( ((((uint32_t)(-__builtin_arm_qadd16(__builtin_arm_qadd16(S->Kd, S->Kd), S->Kp))) ) & 0x0000FFFFUL) | ((((uint32_t)(S->Kd)) << (16)) & 0xFFFF0000UL) );
# 85 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_q15.c"
  if (resetStateFlag)
  {
...
# 31 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_q31.c" 1
# 51 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_q31.c"
void arm_pid_init_q31(
  arm_pid_instance_q31 * S,
  int32_t resetStateFlag)
{
  ...
  S->A0 = __builtin_arm_qadd(__builtin_arm_qadd(S->Kp, S->Ki), S->Kd);


  S->A1 = -__builtin_arm_qadd(__builtin_arm_qadd(S->Kd, S->Kd), S->Kp);
# 79 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_init_q31.c"
  S->A2 = S->Kd;
...
# 32 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_reset_f32.c" 1
# 45 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_reset_f32.c"
void arm_pid_reset_f32(
  arm_pid_instance_f32 * S)
{
...
# 33 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_reset_q15.c" 1
# 45 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_reset_q15.c"
void arm_pid_reset_q15(
  arm_pid_instance_q15 * S)
{
...
# 34 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_reset_q31.c" 1
# 45 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_pid_reset_q31.c"
void arm_pid_reset_q31(
  arm_pid_instance_q31 * S)
{
...
# 35 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2


# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_sin_cos_f32.c" 1
# 30 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_sin_cos_f32.c"
# 1 "../Middlewares/CMSIS/DSP/Inc\\arm_common_tables.h" 1
# 33 "../Middlewares/CMSIS/DSP/Inc\\arm_common_tables.h"
...
# 34 "../Middlewares/CMSIS/DSP/Inc\\arm_common_tables.h" 2
...
# 31 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_sin_cos_f32.c" 2
# 45 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_sin_cos_f32.c"
void arm_sin_cos_f32(
  float32_t theta,
  float32_t * pSinVal,
  float32_t * pCosVal)
...
# 38 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2

# 1 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_sin_cos_q31.c" 1
# 51 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/arm_sin_cos_q31.c"
void arm_sin_cos_q31(
  q31_t theta,
  q31_t * pSinVal,
  q31_t * pCosVal)
...
# 40 "../Middlewares/CMSIS/DSP/Src/ControllerFunctions/ControllerFunctions.c" 2
