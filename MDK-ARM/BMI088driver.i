# 1 "../User/Bsp/BMI088driver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/BMI088driver.c" 2
...
# 5 "../User/Bsp/inc\\BMI088driver.h" 2
# 1 "../Core/Inc\\main.h" 1
# 30 "../Core/Inc\\main.h"
...
# 6 "../User/Bsp/inc\\BMI088driver.h" 2
...
# 2 "../User/Bsp/BMI088driver.c" 2

float BMI088_ACCEL_SEN = 0.0008974358974f;
float BMI088_GYRO_SEN = 0.00106526443603169529841533860381f;
# 103 "../User/Bsp/BMI088driver.c"
static void BMI088_write_single_reg(uint8_t reg, uint8_t data);
static void BMI088_read_single_reg(uint8_t reg, uint8_t *return_data);

static void BMI088_read_muli_reg(uint8_t reg, uint8_t *buf, uint8_t len);
# 120 "../User/Bsp/BMI088driver.c"
static uint8_t write_BMI088_accel_reg_data_error[6][3] =
    {
        ...
        {0x40, (0x2 << 0x4)| (0xB << 0x0) | 0x80, BMI088_ACC_CONF_ERROR},
        {0x41, (0x0 << 0x0), BMI088_ACC_RANGE_ERROR},
        {0x53, (0x1 << 0x3) | (0x0 << 0x2) | (0x0 << 0x1), BMI088_INT1_IO_CTRL_ERROR},
        {0x58, (0x1 << 0x2), BMI088_INT_MAP_DATA_ERROR}

};
# 138 "../User/Bsp/BMI088driver.c"
static uint8_t write_BMI088_gyro_reg_data_error[6][3] =
    {
        {0x0F, (0x0 << 0x0), BMI088_GYRO_RANGE_ERROR},
        {0x10, 0x02 | 0x80, BMI088_GYRO_BANDWIDTH_ERROR},
        {0x11, 0x00, BMI088_GYRO_LPM1_ERROR},
        {0x15, 0x80, BMI088_GYRO_CTRL_ERROR},
        {0x16, (0x0 << 0x1) | (0x0 << 0x0), BMI088_GYRO_INT3_INT4_IO_CONF_ERROR},
        {0x18, 0x01, BMI088_GYRO_INT3_INT4_IO_MAP_ERROR}

};
# 156 "../User/Bsp/BMI088driver.c"
...
uint8_t bmi088_accel_init(void)
{
    ...
    { BMI088_ACCEL_NS_L(); BMI088_read_write_byte((0x00) | 0x80); BMI088_read_write_byte(0x55); (res) = BMI088_read_write_byte(0x55); BMI088_ACCEL_NS_H(); };
    BMI088_delay_us(150);
    { BMI088_ACCEL_NS_L(); BMI088_read_write_byte((0x00) | 0x80); BMI088_read_write_byte(0x55); (res) = BMI088_read_write_byte(0x55); BMI088_ACCEL_NS_H(); };
    BMI088_delay_us(150);


    { BMI088_ACCEL_NS_L(); BMI088_write_single_reg((0x7E), (0xB6)); BMI088_ACCEL_NS_H(); };
    BMI088_delay_ms(80);
    ...
    for (write_reg_num = 0; write_reg_num < 6; write_reg_num++)
    {
        ...
        { BMI088_ACCEL_NS_L(); BMI088_write_single_reg((write_BMI088_accel_reg_data_error[write_reg_num][0]), (write_BMI088_accel_reg_data_error[write_reg_num][1])); BMI088_ACCEL_NS_H(); };
        BMI088_delay_us(150);

        { BMI088_ACCEL_NS_L(); BMI088_read_write_byte((write_BMI088_accel_reg_data_error[write_reg_num][0]) | 0x80); BMI088_read_write_byte(0x55); (res) = BMI088_read_write_byte(0x55); BMI088_ACCEL_NS_H(); };
        BMI088_delay_us(150);
...
uint8_t bmi088_gyro_init(void)
{
    ...
    { BMI088_GYRO_NS_L(); BMI088_read_single_reg((0x00), &(res)); BMI088_GYRO_NS_H(); };
    BMI088_delay_us(150);
    { BMI088_GYRO_NS_L(); BMI088_read_single_reg((0x00), &(res)); BMI088_GYRO_NS_H(); };
    BMI088_delay_us(150);


    { BMI088_GYRO_NS_L(); BMI088_write_single_reg((0x14), (0xB6)); BMI088_GYRO_NS_H(); };
    BMI088_delay_ms(80);
    ...
    for (write_reg_num = 0; write_reg_num < 6; write_reg_num++)
    {
        ...
        { BMI088_GYRO_NS_L(); BMI088_write_single_reg((write_BMI088_gyro_reg_data_error[write_reg_num][0]), (write_BMI088_gyro_reg_data_error[write_reg_num][1])); BMI088_GYRO_NS_H(); };
        BMI088_delay_us(150);

        { BMI088_GYRO_NS_L(); BMI088_read_single_reg((write_BMI088_gyro_reg_data_error[write_reg_num][0]), &(res)); BMI088_GYRO_NS_H(); };
        BMI088_delay_us(150);
...
# 282 "../User/Bsp/BMI088driver.c"
void BMI088_read(float gyro[3], float accel[3], float *temperate)
{
    uint8_t buf[8] = {0, 0, 0, 0, 0, 0};
    int16_t bmi088_raw_temp;

    { BMI088_ACCEL_NS_L(); BMI088_read_write_byte((0x12) | 0x80); BMI088_read_muli_reg(0x12, buf, 6); BMI088_ACCEL_NS_H(); };
    ...
    { BMI088_GYRO_NS_L(); BMI088_read_muli_reg((0x00), (buf), (8)); BMI088_GYRO_NS_H(); };
    if(buf[0] == 0x0F)
    {
        bmi088_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
    ...
    { BMI088_ACCEL_NS_L(); BMI088_read_write_byte((0x22) | 0x80); BMI088_read_muli_reg(0x22, buf, 2); BMI088_ACCEL_NS_H(); };
...
# 328 "../User/Bsp/BMI088driver.c"
static void BMI088_write_single_reg(uint8_t reg, uint8_t data)
{
    BMI088_read_write_byte(reg);
    BMI088_read_write_byte(data);
}
# 342 "../User/Bsp/BMI088driver.c"
static void BMI088_read_single_reg(uint8_t reg, uint8_t *return_data)
{
    BMI088_read_write_byte(reg | 0x80);
    *return_data = BMI088_read_write_byte(0x55);
}
# 370 "../User/Bsp/BMI088driver.c"
static void BMI088_read_muli_reg(uint8_t reg, uint8_t *buf, uint8_t len)
{
    BMI088_read_write_byte(reg | 0x80);
