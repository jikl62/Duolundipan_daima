...
MX_DMA_Init:
.Lfunc_begin0:
	.file	3 "D:\\horizon\\Horizon_Infantry (2)\\MDK-ARM" "../Core/Src/dma.c"
...
.LBB0_1:
	...
	movs	r0, #0
.Ltmp1:
	.loc	3 43 26                         @ ../Core/Src/dma.c:43:26
	str	r0, [sp, #52]
	movw	r0, #14384
	movt	r0, #16386
	.loc	3 43 115                        @ ../Core/Src/dma.c:43:115
	ldr	r1, [r0]
	orr	r1, r1, #4194304
	str	r1, [r0]
	.loc	3 43 212                        @ ../Core/Src/dma.c:43:212
	ldr	r0, [r0]
	.loc	3 43 221                        @ ../Core/Src/dma.c:43:221
	and	r0, r0, #4194304
	.loc	3 43 146                        @ ../Core/Src/dma.c:43:146
	str	r0, [sp, #52]
	.loc	3 43 250                        @ ../Core/Src/dma.c:43:250
	ldr	r0, [sp, #52]
	.loc	3 43 258                        @ ../Core/Src/dma.c:43:258
	b	.LBB0_2
.Ltmp2:
.LBB0_2:
...
.LBB0_3:
	...
	movs	r0, #0
.Ltmp3:
	.loc	3 44 26                         @ ../Core/Src/dma.c:44:26
	str	r0, [sp, #48]
	movw	r0, #14384
	movt	r0, #16386
	.loc	3 44 115                        @ ../Core/Src/dma.c:44:115
	ldr	r1, [r0]
	orr	r1, r1, #2097152
	str	r1, [r0]
	.loc	3 44 212                        @ ../Core/Src/dma.c:44:212
	ldr	r0, [r0]
	.loc	3 44 221                        @ ../Core/Src/dma.c:44:221
	and	r0, r0, #2097152
	.loc	3 44 146                        @ ../Core/Src/dma.c:44:146
	str	r0, [sp, #48]
	.loc	3 44 250                        @ ../Core/Src/dma.c:44:250
	ldr	r0, [sp, #48]
	.loc	3 44 258                        @ ../Core/Src/dma.c:44:258
	b	.LBB0_4
.Ltmp4:
.LBB0_4:
	.loc	3 0 258                         @ ../Core/Src/dma.c:0:258
	movs	r0, #12
	...
	bl	HAL_NVIC_EnableIRQ
	.loc	3 75 1                          @ ../Core/Src/dma.c:75:1
	add	sp, #56
	pop	{r7, pc}
.Ltmp5:
.Lfunc_end0:
...
.Linfo_string1:
	.asciz	"dma.c"                         @ string offset=68
.Linfo_string2:
	.asciz	"D:\\horizon\\Horizon_Infantry (2)\\MDK-ARM" @ string offset=74
.Linfo_string3:
	.asciz	"signed char"                   @ string offset=114
.Linfo_string4:
	.asciz	"NonMaskableInt_IRQn"           @ string offset=126
.Linfo_string5:
	.asciz	"MemoryManagement_IRQn"         @ string offset=146
.Linfo_string6:
	.asciz	"BusFault_IRQn"                 @ string offset=168
.Linfo_string7:
	.asciz	"UsageFault_IRQn"               @ string offset=182
.Linfo_string8:
	.asciz	"SVCall_IRQn"                   @ string offset=198
.Linfo_string9:
	.asciz	"DebugMonitor_IRQn"             @ string offset=210
.Linfo_string10:
	.asciz	"PendSV_IRQn"                   @ string offset=228
.Linfo_string11:
	.asciz	"SysTick_IRQn"                  @ string offset=240
.Linfo_string12:
	.asciz	"WWDG_IRQn"                     @ string offset=253
.Linfo_string13:
	.asciz	"PVD_IRQn"                      @ string offset=263
.Linfo_string14:
	.asciz	"TAMP_STAMP_IRQn"               @ string offset=272
.Linfo_string15:
	.asciz	"RTC_WKUP_IRQn"                 @ string offset=288
.Linfo_string16:
	.asciz	"FLASH_IRQn"                    @ string offset=302
.Linfo_string17:
	.asciz	"RCC_IRQn"                      @ string offset=313
.Linfo_string18:
	.asciz	"EXTI0_IRQn"                    @ string offset=322
.Linfo_string19:
	.asciz	"EXTI1_IRQn"                    @ string offset=333
.Linfo_string20:
	.asciz	"EXTI2_IRQn"                    @ string offset=344
.Linfo_string21:
	.asciz	"EXTI3_IRQn"                    @ string offset=355
.Linfo_string22:
	.asciz	"EXTI4_IRQn"                    @ string offset=366
.Linfo_string23:
	.asciz	"DMA1_Stream0_IRQn"             @ string offset=377
.Linfo_string24:
	.asciz	"DMA1_Stream1_IRQn"             @ string offset=395
.Linfo_string25:
	.asciz	"DMA1_Stream2_IRQn"             @ string offset=413
.Linfo_string26:
	.asciz	"DMA1_Stream3_IRQn"             @ string offset=431
.Linfo_string27:
	.asciz	"DMA1_Stream4_IRQn"             @ string offset=449
.Linfo_string28:
	.asciz	"DMA1_Stream5_IRQn"             @ string offset=467
.Linfo_string29:
	.asciz	"DMA1_Stream6_IRQn"             @ string offset=485
.Linfo_string30:
	.asciz	"ADC_IRQn"                      @ string offset=503
.Linfo_string31:
	.asciz	"CAN1_TX_IRQn"                  @ string offset=512
.Linfo_string32:
	.asciz	"CAN1_RX0_IRQn"                 @ string offset=525
.Linfo_string33:
	.asciz	"CAN1_RX1_IRQn"                 @ string offset=539
.Linfo_string34:
	.asciz	"CAN1_SCE_IRQn"                 @ string offset=553
.Linfo_string35:
	.asciz	"EXTI9_5_IRQn"                  @ string offset=567
.Linfo_string36:
	.asciz	"TIM1_BRK_TIM9_IRQn"            @ string offset=580
.Linfo_string37:
	.asciz	"TIM1_UP_TIM10_IRQn"            @ string offset=599
.Linfo_string38:
	.asciz	"TIM1_TRG_COM_TIM11_IRQn"       @ string offset=618
.Linfo_string39:
	.asciz	"TIM1_CC_IRQn"                  @ string offset=642
.Linfo_string40:
	.asciz	"TIM2_IRQn"                     @ string offset=655
.Linfo_string41:
	.asciz	"TIM3_IRQn"                     @ string offset=665
.Linfo_string42:
	.asciz	"TIM4_IRQn"                     @ string offset=675
.Linfo_string43:
	.asciz	"I2C1_EV_IRQn"                  @ string offset=685
.Linfo_string44:
	.asciz	"I2C1_ER_IRQn"                  @ string offset=698
.Linfo_string45:
	.asciz	"I2C2_EV_IRQn"                  @ string offset=711
.Linfo_string46:
	.asciz	"I2C2_ER_IRQn"                  @ string offset=724
.Linfo_string47:
	.asciz	"SPI1_IRQn"                     @ string offset=737
.Linfo_string48:
	.asciz	"SPI2_IRQn"                     @ string offset=747
.Linfo_string49:
	.asciz	"USART1_IRQn"                   @ string offset=757
.Linfo_string50:
	.asciz	"USART2_IRQn"                   @ string offset=769
.Linfo_string51:
	.asciz	"USART3_IRQn"                   @ string offset=781
.Linfo_string52:
	.asciz	"EXTI15_10_IRQn"                @ string offset=793
.Linfo_string53:
	.asciz	"RTC_Alarm_IRQn"                @ string offset=808
.Linfo_string54:
	.asciz	"OTG_FS_WKUP_IRQn"              @ string offset=823
.Linfo_string55:
	.asciz	"TIM8_BRK_TIM12_IRQn"           @ string offset=840
.Linfo_string56:
	.asciz	"TIM8_UP_TIM13_IRQn"            @ string offset=860
.Linfo_string57:
	.asciz	"TIM8_TRG_COM_TIM14_IRQn"       @ string offset=879
.Linfo_string58:
	.asciz	"TIM8_CC_IRQn"                  @ string offset=903
.Linfo_string59:
	.asciz	"DMA1_Stream7_IRQn"             @ string offset=916
.Linfo_string60:
	.asciz	"FSMC_IRQn"                     @ string offset=934
.Linfo_string61:
	.asciz	"SDIO_IRQn"                     @ string offset=944
.Linfo_string62:
	.asciz	"TIM5_IRQn"                     @ string offset=954
.Linfo_string63:
	.asciz	"SPI3_IRQn"                     @ string offset=964
.Linfo_string64:
	.asciz	"UART4_IRQn"                    @ string offset=974
.Linfo_string65:
	.asciz	"UART5_IRQn"                    @ string offset=985
.Linfo_string66:
	.asciz	"TIM6_DAC_IRQn"                 @ string offset=996
.Linfo_string67:
	.asciz	"TIM7_IRQn"                     @ string offset=1010
.Linfo_string68:
	.asciz	"DMA2_Stream0_IRQn"             @ string offset=1020
.Linfo_string69:
	.asciz	"DMA2_Stream1_IRQn"             @ string offset=1038
.Linfo_string70:
	.asciz	"DMA2_Stream2_IRQn"             @ string offset=1056
.Linfo_string71:
	.asciz	"DMA2_Stream3_IRQn"             @ string offset=1074
.Linfo_string72:
	.asciz	"DMA2_Stream4_IRQn"             @ string offset=1092
.Linfo_string73:
	.asciz	"ETH_IRQn"                      @ string offset=1110
.Linfo_string74:
	.asciz	"ETH_WKUP_IRQn"                 @ string offset=1119
.Linfo_string75:
	.asciz	"CAN2_TX_IRQn"                  @ string offset=1133
.Linfo_string76:
	.asciz	"CAN2_RX0_IRQn"                 @ string offset=1146
.Linfo_string77:
	.asciz	"CAN2_RX1_IRQn"                 @ string offset=1160
.Linfo_string78:
	.asciz	"CAN2_SCE_IRQn"                 @ string offset=1174
.Linfo_string79:
	.asciz	"OTG_FS_IRQn"                   @ string offset=1188
.Linfo_string80:
	.asciz	"DMA2_Stream5_IRQn"             @ string offset=1200
.Linfo_string81:
	.asciz	"DMA2_Stream6_IRQn"             @ string offset=1218
.Linfo_string82:
	.asciz	"DMA2_Stream7_IRQn"             @ string offset=1236
.Linfo_string83:
	.asciz	"USART6_IRQn"                   @ string offset=1254
.Linfo_string84:
	.asciz	"I2C3_EV_IRQn"                  @ string offset=1266
.Linfo_string85:
	.asciz	"I2C3_ER_IRQn"                  @ string offset=1279
.Linfo_string86:
	.asciz	"OTG_HS_EP1_OUT_IRQn"           @ string offset=1292
.Linfo_string87:
	.asciz	"OTG_HS_EP1_IN_IRQn"            @ string offset=1312
.Linfo_string88:
	.asciz	"OTG_HS_WKUP_IRQn"              @ string offset=1331
.Linfo_string89:
	.asciz	"OTG_HS_IRQn"                   @ string offset=1348
.Linfo_string90:
	.asciz	"DCMI_IRQn"                     @ string offset=1360
.Linfo_string91:
	.asciz	"RNG_IRQn"                      @ string offset=1370
.Linfo_string92:
	.asciz	"FPU_IRQn"                      @ string offset=1379
.Linfo_string93:
	.asciz	"CR"                            @ string offset=1388
.Linfo_string94:
	.asciz	"unsigned int"                  @ string offset=1391
.Linfo_string95:
	.asciz	"uint32_t"                      @ string offset=1404
.Linfo_string96:
	.asciz	"PLLCFGR"                       @ string offset=1413
.Linfo_string97:
	.asciz	"CFGR"                          @ string offset=1421
.Linfo_string98:
	.asciz	"CIR"                           @ string offset=1426
.Linfo_string99:
	.asciz	"AHB1RSTR"                      @ string offset=1430
.Linfo_string100:
	.asciz	"AHB2RSTR"                      @ string offset=1439
.Linfo_string101:
	.asciz	"AHB3RSTR"                      @ string offset=1448
.Linfo_string102:
	.asciz	"RESERVED0"                     @ string offset=1457
.Linfo_string103:
	.asciz	"APB1RSTR"                      @ string offset=1467
.Linfo_string104:
	.asciz	"APB2RSTR"                      @ string offset=1476
.Linfo_string105:
	.asciz	"RESERVED1"                     @ string offset=1485
.Linfo_string106:
	.asciz	"__ARRAY_SIZE_TYPE__"           @ string offset=1495
.Linfo_string107:
	.asciz	"AHB1ENR"                       @ string offset=1515
.Linfo_string108:
	.asciz	"AHB2ENR"                       @ string offset=1523
.Linfo_string109:
	.asciz	"AHB3ENR"                       @ string offset=1531
.Linfo_string110:
	.asciz	"RESERVED2"                     @ string offset=1539
.Linfo_string111:
	.asciz	"APB1ENR"                       @ string offset=1549
.Linfo_string112:
	.asciz	"APB2ENR"                       @ string offset=1557
.Linfo_string113:
	.asciz	"RESERVED3"                     @ string offset=1565
.Linfo_string114:
	.asciz	"AHB1LPENR"                     @ string offset=1575
.Linfo_string115:
	.asciz	"AHB2LPENR"                     @ string offset=1585
.Linfo_string116:
	.asciz	"AHB3LPENR"                     @ string offset=1595
.Linfo_string117:
	.asciz	"RESERVED4"                     @ string offset=1605
.Linfo_string118:
	.asciz	"APB1LPENR"                     @ string offset=1615
.Linfo_string119:
	.asciz	"APB2LPENR"                     @ string offset=1625
.Linfo_string120:
	.asciz	"RESERVED5"                     @ string offset=1635
.Linfo_string121:
	.asciz	"BDCR"                          @ string offset=1645
.Linfo_string122:
	.asciz	"CSR"                           @ string offset=1650
.Linfo_string123:
	.asciz	"RESERVED6"                     @ string offset=1654
.Linfo_string124:
	.asciz	"SSCGR"                         @ string offset=1664
.Linfo_string125:
	.asciz	"PLLI2SCFGR"                    @ string offset=1670
.Linfo_string126:
	.asciz	"RCC_TypeDef"                   @ string offset=1681
.Linfo_string127:
	.asciz	"MX_DMA_Init"                   @ string offset=1693
.Linfo_string128:
	.asciz	"tmpreg"                        @ string offset=1705
