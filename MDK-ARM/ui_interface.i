# 1 "../User/UI/ui_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/UI/ui_interface.c" 2
...
# 111 "../User/UI/ui_interface.c"
void ui_proc_1_frame(ui_1_frame_t *msg) { msg->header.SOF = 0xA5; msg->header.length = 6 + 15 * 1; msg->header.seq = seq++; msg->header.crc8 = calc_crc8((uint8_t*)msg, 4); msg->header.cmd_id = 0x0301; msg->header.sub_id = 0x0101; msg->header.send_id = ui_self_id; msg->header.recv_id = ui_self_id + 256; msg->crc16 = calc_crc16((uint8_t*)msg, 13 + 15 * 1); }
void ui_proc_2_frame(ui_2_frame_t *msg) { msg->header.SOF = 0xA5; msg->header.length = 6 + 15 * 2; msg->header.seq = seq++; msg->header.crc8 = calc_crc8((uint8_t*)msg, 4); msg->header.cmd_id = 0x0301; msg->header.sub_id = 0x0102; msg->header.send_id = ui_self_id; msg->header.recv_id = ui_self_id + 256; msg->crc16 = calc_crc16((uint8_t*)msg, 13 + 15 * 2); }
void ui_proc_5_frame(ui_5_frame_t *msg) { msg->header.SOF = 0xA5; msg->header.length = 6 + 15 * 5; msg->header.seq = seq++; msg->header.crc8 = calc_crc8((uint8_t*)msg, 4); msg->header.cmd_id = 0x0301; msg->header.sub_id = 0x0103; msg->header.send_id = ui_self_id; msg->header.recv_id = ui_self_id + 256; msg->crc16 = calc_crc16((uint8_t*)msg, 13 + 15 * 5); }
void ui_proc_7_frame(ui_7_frame_t *msg) { msg->header.SOF = 0xA5; msg->header.length = 6 + 15 * 7; msg->header.seq = seq++; msg->header.crc8 = calc_crc8((uint8_t*)msg, 4); msg->header.cmd_id = 0x0301; msg->header.sub_id = 0x0104; msg->header.send_id = ui_self_id; msg->header.recv_id = ui_self_id + 256; msg->crc16 = calc_crc16((uint8_t*)msg, 13 + 15 * 7); }
