# 1 "../User/Bsp/RUI_DBUS.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/RUI_DBUS.c" 2
...
# 2 "../User/Bsp/RUI_DBUS.c" 2
# 17 "../User/Bsp/RUI_DBUS.c"
void RUI_F_DUBS_Resovled(uint8_t* Data, DBUS_Typedef *RUI_V_DBUS)
{
    RUI_V_DBUS->RUI_V_DBUS_ONLINE_JUDGE_TIME = 30;
