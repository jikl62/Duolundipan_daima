...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c" 2
...
# 77 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c" 2
...
HAL_StatusTypeDef FLASH_WaitForLastOperation(uint32_t Timeout);
# 154 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c"
HAL_StatusTypeDef HAL_FLASH_Program(uint32_t TypeProgram, uint32_t Address, uint64_t Data)
{
...
# 212 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c"
HAL_StatusTypeDef HAL_FLASH_Program_IT(uint32_t TypeProgram, uint32_t Address, uint64_t Data)
{
...
void HAL_FLASH_IRQHandler(void)
{
  ...
  if (pFlash.ProcedureOnGoing == FLASH_PROC_NONE)
  {
    ...
    ((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->CR) &= ~(((0x1UL << (0U)) | (0x1UL << (1U)) | (0x0FUL << (3U)) | ((0x1UL << (2U))))));
...
# 376 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c"
...
# 530 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c"
uint32_t HAL_FLASH_GetError(void)
{
