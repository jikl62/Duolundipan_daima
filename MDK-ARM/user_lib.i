# 1 "../User/Algorithm/user_lib.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Algorithm/user_lib.c" 2
...
# 2 "../User/Algorithm/user_lib.c" 2
# 1 "../User/Algorithm/inc\\user_lib.h" 1
# 15 "../User/Algorithm/inc\\user_lib.h"
...
# 16 "../User/Algorithm/inc\\user_lib.h" 2
# 1 "../Core/Inc\\main.h" 1
# 30 "../Core/Inc\\main.h"
