# 1 "../User/Bsp/can_bsp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/can_bsp.c" 2
...
void CAN_Filter_Init(void)
{
 CAN_FilterTypeDef CAN_FilterInitStrt;
    ...
    CAN_FilterInitStrt.FilterMode = (0x00000000U);
    CAN_FilterInitStrt.FilterScale = (0x00000001U);
    ...
    CAN_FilterInitStrt.FilterFIFOAssignment = (0x00000000U);

    HAL_CAN_ConfigFilter(&hcan1 , &CAN_FilterInitStrt);
    HAL_CAN_Start(&hcan1);
    HAL_CAN_ActivateNotification(&hcan1 , ((uint32_t)(0x1UL << (1U))));
    ...
    HAL_CAN_Start(&hcan2);
    HAL_CAN_ActivateNotification(&hcan2 , ((uint32_t)(0x1UL << (1U))));

    return;
}
# 55 "../User/Bsp/can_bsp.c"
void canx_send_data(CAN_HandleTypeDef* _hcan , uint16_t stdid , uint8_t* Data)
{
    ...
    TXMessage.DLC = 0x08;
    TXMessage.IDE = (0x00000000U);
    TXMessage.RTR = (0x00000000U);
