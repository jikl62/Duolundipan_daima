...
# 21 "../User/Algorithm/inc\\controller.h"
...
# 28 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_ioreq.h"
...
# 29 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_ioreq.h" 2
...
# 12 "../User/Algorithm/inc\\Power_Ctrl.h"
typedef struct
{
    float Kp;
    float Ki;
...
# 1 "../User/Algorithm/inc\\heat_control.h" 1
# 33 "../User/Start/Inc\\All_Init.h" 2
...
# 37 "../User/Start/Inc/All_Init.h" 2
               ...
               RUI_ROOT_STATUS_Typedef *Root)
{
    switch (mode) {
        ...
        case 1:
        {
            ...
            if(DBUS->KeyBoard.V_PreeNumber && (CAP_DATA->GET.CAP_VOLT > 180.0f || Root->Power == 0))
            {
                MAX_POWER = 250.0f;
            }
            else
            ...
            if(CONTAL->BOTTOM.VW != 0 || Root->RM_DBUS == 0)
            {
                FIX_ANGLE = 0;
            }
            else
        ...
        case 2:
         {
            ...
            uint8_t is_auto_aiming = ((DBUS->Remote.S2_u8 == 2) || (VT13_DBUS.Mouse.R_State == 2)) &&
                                     ((VisionRxDataTemp.Target == 1) && (VisionRxDataTemp.offlinetime <= 900));
            ...
            else if (is_auto_aiming)
            {
                ...
                CONTAL->HEAD.Pitch = RUI_F_MATH_Limit_float(CONTAL->HEAD.Pitch_MAX, CONTAL->HEAD.Pitch_MIN, CONTAL->HEAD.Pitch);
                CONTAL->HEAD.Yaw = RUI_F_MATH_Limit_float(b + 900.0f, b - 900.0f, CONTAL->HEAD.Yaw);
            }
            else
            {


                CONTAL->HEAD.Pitch -= ((float)(DBUS->Remote.CH3_int16) * 0.01f + VT13_DBUS.Mouse.Y_Flt * 0.07f);
                CONTAL->HEAD.Yaw -= ((float)(DBUS->Remote.CH2_int16) * 0.01f + VT13_DBUS.Mouse.X_Flt * 0.07f);
                                  ...
                                  User_Data_T *User_data)
{
  ...
  {AIM = CONTAL->SHOOT_Bask.Angle;}
   ...
   {all_ui.shoot_stutas=1;}else{all_ui.shoot_stutas=0;}
    return AIM;
}
# 330 "../User/App/Robot.c"
float RUI_F_CHASSIS_GET_MAX_TARGET(float MAX_POWER)
{
# 343 "../User/App/Robot.c"
    if (MAX_POWER == 45)
    {
