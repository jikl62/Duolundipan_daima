# 1 "../User/Algorithm/pid_temp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Algorithm/pid_temp.c" 2
# 1 "../User/Algorithm/inc\\pid_temp.h" 1
# 19 "../User/Algorithm/inc\\pid_temp.h"
# 1 "../Core/Inc\\main.h" 1
# 30 "../Core/Inc\\main.h"
...
# 20 "../User/Algorithm/inc\\pid_temp.h" 2
enum PID_MODE
{
    PID_POSITION = 0,
    PID_DELTA
...
# 2 "../User/Algorithm/pid_temp.c" 2
# 36 "../User/Algorithm/pid_temp.c"
...
float PID_calc(pid_type_def *pid, float ref, float set)
{
    ...
    if (pid->mode == PID_POSITION)
    {
        ...
        { if (pid->Iout > pid->max_iout) { pid->Iout = pid->max_iout; } else if (pid->Iout < -pid->max_iout) { pid->Iout = -pid->max_iout; } };
        pid->out = pid->Pout + pid->Iout + pid->Dout;
        { if (pid->out > pid->max_out) { pid->out = pid->max_out; } else if (pid->out < -pid->max_out) { pid->out = -pid->max_out; } };
    }
