# 1 "../User/App/Shoot_Task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/App/Shoot_Task.c" 2
...
# 3 "../User/App/Shoot_Task.c" 2
# 12 "../User/App/Shoot_Task.c"
extern DBUS_Typedef WHW_V_DBUS;
extern MOTOR_Typdef ALL_MOTOR;
