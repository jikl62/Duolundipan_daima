...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c" 2
# 248 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c"
...
# 249 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c" 2
# 269 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_adc.c"
...
HAL_StatusTypeDef HAL_ADC_Start(ADC_HandleTypeDef *hadc)
{
  ...
  if ((((hadc->Instance->CR2) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))))
  {
    ...
    if ((((tmpADC_Common->CCR) & ((0x1FUL << (0U)))) == 0U))
    {
      ...
      if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL))) || ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2100UL))) && ((((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR & (0x1FUL << (0U))) < (0x01UL << (0U)))) || ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL))) && ((((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR & (0x1FUL << (0U))) < (0x10UL << (0U)))))
  ...
  while (!(((((hadc)->Instance->SR) & (((uint32_t)(0x1UL << (1U))))) == (((uint32_t)(0x1UL << (1U)))))))
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if ((Timeout == 0U) || ((HAL_GetTick() - tickstart) > Timeout))
      {
        ...
        if (!(((((hadc)->Instance->SR) & (((uint32_t)(0x1UL << (1U))))) == (((uint32_t)(0x1UL << (1U)))))))
        {
  ...
  while (!(((((hadc)->Instance->SR) & (EventType)) == (EventType))))
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if ((Timeout == 0U) || ((HAL_GetTick() - tickstart) > Timeout))
      {
        ...
        if (!(((((hadc)->Instance->SR) & (EventType)) == (EventType))))
        {
...
void HAL_ADC_IRQHandler(ADC_HandleTypeDef *hadc)
{
  ...
  tmp1 = tmp_sr & ((uint32_t)(0x1UL << (1U)));
  tmp2 = tmp_cr1 & ((uint32_t)(0x1UL << (5U)));
  ...
  tmp1 = tmp_sr & ((uint32_t)(0x1UL << (2U)));
  tmp2 = tmp_cr1 & ((uint32_t)(0x1UL << (7U)));
  ...
  tmp1 = tmp_sr & ((uint32_t)(0x1UL << (0U)));
  tmp2 = tmp_cr1 & ((uint32_t)(0x1UL << (6U)));
  ...
  tmp1 = tmp_sr & ((uint32_t)(0x1UL << (5U)));
  tmp2 = tmp_cr1 & ((uint32_t)(0x1UL << (26U)));
...
HAL_StatusTypeDef HAL_ADC_Start_DMA(ADC_HandleTypeDef *hadc, uint32_t *pData, uint32_t Length)
{
  ...
  if ((hadc->Instance->CR2 & (0x1UL << (8U))) == (0x1UL << (8U)))
  {
