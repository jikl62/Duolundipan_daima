...
_Bool verify_crc16_check_sum(uint8_t *p_msg, uint16_t len);
...
void VT13_Resovled(uint8_t* Data, VT13_Typedef* VT13,VT13_UNION_Typdef *VT13_UNION)
{
 ...
 {
  VT13->RUI_V_VT13_ONLINE_JUDGE_TIME = 30;

  VT13->CRC_flag = 1;

  static uint8_t Key_Q_Lock = 0;
