# 1 "../User/App/Gimbal_Task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/App/Gimbal_Task.c" 2
...
# 18 "../User/Algorithm/inc\\controller.h"
# 1 "../Core/Inc\\main.h" 1
# 30 "../Core/Inc\\main.h"
...
# 19 "../User/Algorithm/inc\\controller.h" 2
...
# 5 "../User/App/inc\\Gimbal_Task.h" 2
...
# 6 "../User/App/inc\\Gimbal_Task.h" 2

# 1 "../User/App/inc/RUI_ROOT_INIT.h" 1
# 16 "../User/App/inc/RUI_ROOT_INIT.h"
# 1 "../User/Bsp/inc\\RUI_DBUS.h" 1
# 19 "../User/Bsp/inc\\RUI_DBUS.h"
# 1 "../Core/Inc\\gpio.h" 1
# 39 "../Core/Inc\\gpio.h"
...
# 17 "../User/App/inc/RUI_ROOT_INIT.h" 2
...
# 24 "../User/App/inc/RUI_ROOT_INIT.h" 2
...
# 25 "../User/App/inc/RUI_ROOT_INIT.h" 2
...
uint8_t MOTOR_PID_Gimbal_INIT(MOTOR_Typdef *MOTOR)
{
    ...
    Feedforward_Init(&MOTOR->DJI_6020_Pitch.PID_F, 2000, PID_F_Pitch,
                     0.5f, 0, 0);
    PID_Init(&MOTOR->DJI_6020_Pitch.PID_P, 6000.0f, 50.0f,
             PID_P_Pitch, 1000, 1000,
             0.0f, 0.0f, 0,
    ...
    PID_Init(&MOTOR->DJI_6020_Pitch.PID_S, 2040.0f, 2000.0f,
             ...
             Integral_Limit|OutputFilter|ErrorHandle
             |Trapezoid_Intergral|ChangingIntegrationRate
             |Derivative_On_Measurement&00000000);
    ...
    PID_Init(&MOTOR->DJI_6020_Yaw.PID_S, 15000.0f, 2000.0f,
             ...
             Integral_Limit|OutputFilter|ErrorHandle
             |Trapezoid_Intergral|ChangingIntegrationRate
             |Derivative_On_Measurement|DerivativeFilter&00000000);
...
uint8_t Gimbal_AIM_INIT(RUI_ROOT_STATUS_Typedef *Root, MOTOR_Typdef *MOTOR)
{
    ...
    if (Root->MOTOR_HEAD_Pitch == 0 ||
        Root->MOTOR_HEAD_Yaw == 0)
        return 0;
