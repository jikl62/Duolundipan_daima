...
# 77 "../Core/Src/usart.c"
  ...
  huart3.Init.WordLength = ((uint32_t)(0x1UL << (12U)));
  huart3.Init.StopBits = 0x00000000U;
  huart3.Init.Parity = ((uint32_t)(0x1UL << (10U)));
  huart3.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
...
# 106 "../Core/Src/usart.c"
  huart6.Instance = ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL));
  huart6.Init.BaudRate = 115200;
  huart6.Init.WordLength = 0x00000000U;
  huart6.Init.StopBits = 0x00000000U;
  huart6.Init.Parity = 0x00000000U;
  huart6.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
  huart6.Init.HwFlowCtl = 0x00000000U;
  huart6.Init.OverSampling = 0x00000000U;
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    hdma_usart1_rx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x088UL));
    ...
    do{ (uartHandle)->hdmarx = &(hdma_usart1_rx); (hdma_usart1_rx).Parent = (uartHandle); } while(0U);
    ...
    hdma_usart1_tx.Init.Mode = ((uint32_t)(0x1UL << (8U)));
    ...
    do{ (uartHandle)->hdmatx = &(hdma_usart1_tx); (hdma_usart1_tx).Parent = (uartHandle); } while(0U);
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4800UL)))
  {




    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (18U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (18U)))); (void)tmpreg; } while(0U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0800)|((uint16_t)0x0400);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000003U;
    GPIO_InitStruct.Alternate = ((uint8_t)0x07);
    ...
    hdma_usart3_rx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x028UL));
    hdma_usart3_rx.Init.Channel = 0x08000000U;
    hdma_usart3_rx.Init.Direction = 0x00000000U;
    hdma_usart3_rx.Init.PeriphInc = 0x00000000U;
    hdma_usart3_rx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_usart3_rx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_usart3_rx.Init.MemDataAlignment = 0x00000000U;
    hdma_usart3_rx.Init.Mode = 0x00000000U;
    hdma_usart3_rx.Init.Priority = 0x00000000U;
    hdma_usart3_rx.Init.FIFOMode = 0x00000000U;
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL)))
  {




    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (5U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (5U)))); (void)tmpreg; } while(0U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x4000)|((uint16_t)0x0200);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000003U;
    ...
    hdma_usart6_rx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL));
    hdma_usart6_rx.Init.Channel = 0x0A000000U;
    hdma_usart6_rx.Init.Direction = 0x00000000U;
    hdma_usart6_rx.Init.PeriphInc = 0x00000000U;
    hdma_usart6_rx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_usart6_rx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_usart6_rx.Init.MemDataAlignment = 0x00000000U;
    hdma_usart6_rx.Init.Mode = 0x00000000U;
    hdma_usart6_rx.Init.Priority = ((uint32_t)(0x2UL << (16U)));
    hdma_usart6_rx.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_usart6_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (uartHandle)->hdmarx = &(hdma_usart6_rx); (hdma_usart6_rx).Parent = (uartHandle); } while(0U);


    hdma_usart6_tx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x0A0UL));
    hdma_usart6_tx.Init.Channel = 0x0A000000U;
    hdma_usart6_tx.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_usart6_tx.Init.PeriphInc = 0x00000000U;
    hdma_usart6_tx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_usart6_tx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_usart6_tx.Init.MemDataAlignment = 0x00000000U;
    hdma_usart6_tx.Init.Mode = 0x00000000U;
    hdma_usart6_tx.Init.Priority = 0x00000000U;
    hdma_usart6_tx.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_usart6_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (uartHandle)->hdmatx = &(hdma_usart6_tx); (hdma_usart6_tx).Parent = (uartHandle); } while(0U);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0200));
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4800UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (18U))));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0800)|((uint16_t)0x0400));
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~((0x1UL << (5U))));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), ((uint16_t)0x4000)|((uint16_t)0x0200));
