...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c" 2
...
# 68 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c" 2
...
__attribute__((weak)) HAL_StatusTypeDef HAL_RCC_OscConfig(const RCC_OscInitTypeDef *RCC_OscInitStruct)
{
  uint32_t tickstart;
  uint32_t pll_config;
