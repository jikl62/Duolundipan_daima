...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
# 20 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
# 1 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_ctlreq.h" 1
# 28 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_ctlreq.h"
...
# 29 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_ctlreq.h" 2
...
# 21 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
...
# 22 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
...
# 855 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_GetStatus(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req)
{
  switch (pdev->dev_state)
  {
...
# 950 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_ParseSetupRequest(USBD_SetupReqTypedef *req, uint8_t *pdata)
{
  uint8_t *pbuff = pdata;
...
# 979 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_CtlError(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req)
{
  (void)req;
...
# 996 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
{
  uint8_t idx = 0U;
  uint8_t *pdesc;
  ...
  pdesc = desc;
  *len = (((512U) < (((uint16_t)USBD_GetLen(pdesc) * 2U) + 2U)) ? (512U) : (((uint16_t)USBD_GetLen(pdesc) * 2U) + 2U));
...
# 1032 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static uint8_t USBD_GetLen(uint8_t *buf)
{
  uint8_t len = 0U;
  uint8_t *pbuff = buf;
