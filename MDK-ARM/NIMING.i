...
# 10 "../User/Bsp/NIMING.c" 2


uint8_t anonymity_au8[70] = {0};
# 21 "../User/Bsp/NIMING.c"
void Anonymity_TX(int16_t a_x,int16_t a_y,int16_t a_z,int16_t g_x,int16_t g_y,int16_t g_z,int16_t m_x,int16_t m_y,int16_t m_z,int32_t bar)
{
    ...
    anonymity_au8[_cnt++]=0;

    _temp = a_x;
    anonymity_au8[_cnt++]=( *( (char *)(&_temp) ) );
    anonymity_au8[_cnt++]=( *( (char *)(&_temp) + 1) );
    _temp = a_y;
    anonymity_au8[_cnt++]=( *( (char *)(&_temp) ) );
    anonymity_au8[_cnt++]=( *( (char *)(&_temp) + 1) );
    _temp = a_z;
