# 1 "../User/Bsp/bsp_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/bsp_adc.c" 2
...
void init_vrefint_reciprocal(void)
{
    ...
    for(i = 0; i < 200; i++)
    {
        total_adc += adcx_get_chx_value(&hadc1, ((uint32_t)((uint32_t)((0x10UL << (0U)) | (0x01UL << (0U))))));
    }
...
float get_temprate(void)
{
    ...
    adcx = adcx_get_chx_value(&hadc1, ((uint32_t)((uint32_t)(0x10UL << (0U)))));
...
float get_battery_voltage(void)
{
    ...
    adcx = adcx_get_chx_value(&hadc3, ((uint32_t)(0x08UL << (0U))));
