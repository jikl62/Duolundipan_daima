...
# 24 "../Core/Src/freertos.c" 2
# 1 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS\\cmsis_os.h" 1
# 58 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS\\cmsis_os.h"
...
static StackType_t xTimerStack[256];
...
# 132 "../Core/Src/freertos.c"
  ...
  const osThreadDef_t os_thread_def_RobotUITask = { "RobotUITask", (StartRobotUITask), (osPriorityLow), (0), (512), 0, 0 };
  RobotUITaskHandle = osThreadCreate(&os_thread_def_RobotUITask, 0);


  const osThreadDef_t os_thread_def_MoveTask = { "MoveTask", (StartMoveTask), (osPriorityNormal), (0), (256), 0, 0 };
  MoveTaskHandle = osThreadCreate(&os_thread_def_MoveTask, 0);


  const osThreadDef_t os_thread_def_DefiantTask = { "DefiantTask", (StartDefiantTask), (osPriorityNormal), (0), (256), 0, 0 };
  DefiantTaskHandle = osThreadCreate(&os_thread_def_DefiantTask, 0);


  const osThreadDef_t os_thread_def_IMUTask = { "IMUTask", (StartIMUTask), (osPriorityHigh), (0), (512), 0, 0 };
  IMUTaskHandle = osThreadCreate(&os_thread_def_IMUTask, 0);


  const osThreadDef_t os_thread_def_RootTask = { "RootTask", (StartRootTask), (osPriorityHigh), (0), (128), 0, 0 };
  RootTaskHandle = osThreadCreate(&os_thread_def_RootTask, 0);
...
__attribute__((weak)) void StartDefaultTask(void const * argument)
{
...
__attribute__((weak)) void StartRobotUITask(void const * argument)
{
...
__attribute__((weak)) void StartMoveTask(void const * argument)
{
...
__attribute__((weak)) void StartDefiantTask(void const * argument)
{
...
__attribute__((weak)) void StartIMUTask(void const * argument)
{
...
__attribute__((weak)) void StartRootTask(void const * argument)
{
