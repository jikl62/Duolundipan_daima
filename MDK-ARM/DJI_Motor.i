# 1 "../User/Bsp/DJI_Motor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/DJI_Motor.c" 2
# 24 "../User/Bsp/DJI_Motor.c"
...
# 196 "../Middlewares/CMSIS/DSP/Inc\\arm_math.h"
...
# 26 "../User/Bsp/DJI_Motor.c" 2
extern QEKF_INS_t QEKF_INS;
# 35 "../User/Bsp/DJI_Motor.c"
void RUI_F_MOTOR_CAN_RX_3508RM(DJI_MOTOR_DATA_Typedef* DATA , uint8_t* can_data)
{
