...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../USB_DEVICE/App/usbd_cdc_if.c" 2
# 22 "../USB_DEVICE/App/usbd_cdc_if.c"
...
# 23 "../USB_DEVICE/App/usbd_cdc_if.c" 2
...
# 35 "../USB_DEVICE/App/usbd_cdc_if.c" 2
...
static int8_t CDC_Receive_FS(uint8_t* Buf, uint32_t *Len)
{
 ...
 if (Buf != 0 && *Len > 0)
  {
      Vision_Rx_Data(Buf, &VisionRxDataTemp);
