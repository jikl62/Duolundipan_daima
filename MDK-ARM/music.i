...
# 10 "../User/Bsp/music.c" 2
# 55 "../User/Bsp/music.c"
unsigned int notes_jiaofu[] = {
        196,262,311,294,262,311,262,294,262,208,233,196,0,
        196,262,311,294,262,311,262,294,262,196,185,175,0,
        175,208,247,294, 175,208,247,262,0,
        262,311,466,415,392,466,415,415,392,392,247,262,0,
        523,523,494,466, 466,587,523,415,392,
        392,466,392,349, 349,415,392,349,392
};
...
unsigned int notes_heimaojingzhang[] = {
        392,0,392,0,392,440,330,392,349,
        294,330,349,294,494,440,494,392,
        349,0,349,0,349,392,294,349,330,
        220,220,247,262,294,440,0,392,247,294,262,0,
        220,330,330,330,440,392,349,330,349,349,349,294,0,
        247,294,294,294,392,349,330,294,330,330,330,262,0,
        262,523,440,440,392,440,494,494,440,494,0,
        247,494,415,415,370,415,440,440,392,440,
        220,247,262,165,392,392,349,392,0,
        440,440,392,440,494,494,0,392,523,0
};
...
unsigned int notes_huluwa[] = {
        262,262,330,262,262,330,
        440,440,440,392,440,392,262,330,
        523,440,440,392,440,392,262,294,
        494,392,330,392,
        523,440,440,392,392,440,440,0,392,262,330,
        523,440,440,392,392,440,440,0,392,262,294,
        330,262,220,262,
        330,392,440,330,392,440,
        523,494,392,440
};
...
void noTone(void){
    (((0x00000008U) == 0x00000000U) ? ((&htim4)->Instance->CCR1 = (0)) : ((0x00000008U) == 0x00000004U) ? ((&htim4)->Instance->CCR2 = (0)) : ((0x00000008U) == 0x00000008U) ? ((&htim4)->Instance->CCR3 = (0)) : ((&htim4)->Instance->CCR4 = (0)));
    osDelay(30);
}

void playSong_jiaofu(void){
    for (i = 0; i < sizeof(notes_jiaofu)/sizeof(notes_jiaofu[0]); i++) {
        Frequency = CLOCK / notes_jiaofu[i];
        htim4.Instance->ARR = Frequency;
        (((0x00000008U) == 0x00000000U) ? ((&htim4)->Instance->CCR1 = (Frequency / 2)) : ((0x00000008U) == 0x00000004U) ? ((&htim4)->Instance->CCR2 = (Frequency / 2)) : ((0x00000008U) == 0x00000008U) ? ((&htim4)->Instance->CCR3 = (Frequency / 2)) : ((&htim4)->Instance->CCR4 = (Frequency / 2)));
...
void playSong_heimaojingzhang(void){
    for (i = 0; i < sizeof(notes_heimaojingzhang)/sizeof(notes_heimaojingzhang[0]); i++) {
        Frequency = CLOCK / notes_heimaojingzhang[i];
        htim4.Instance->ARR = Frequency;
        (((0x00000008U) == 0x00000000U) ? ((&htim4)->Instance->CCR1 = (Frequency / 2)) : ((0x00000008U) == 0x00000004U) ? ((&htim4)->Instance->CCR2 = (Frequency / 2)) : ((0x00000008U) == 0x00000008U) ? ((&htim4)->Instance->CCR3 = (Frequency / 2)) : ((&htim4)->Instance->CCR4 = (Frequency / 2)));
...
void playSong_huluwa(void){
    for (i = 0; i < sizeof(notes_huluwa)/sizeof(notes_huluwa[0]); i++) {
        Frequency = CLOCK / notes_huluwa[i];
        htim4.Instance->ARR = Frequency;
        (((0x00000008U) == 0x00000000U) ? ((&htim4)->Instance->CCR1 = (Frequency / 2)) : ((0x00000008U) == 0x00000004U) ? ((&htim4)->Instance->CCR2 = (Frequency / 2)) : ((0x00000008U) == 0x00000008U) ? ((&htim4)->Instance->CCR3 = (Frequency / 2)) : ((&htim4)->Instance->CCR4 = (Frequency / 2)));
