...
# 8 "../User/Bsp/ws2812.c" 2

# 1 "../User/Bsp/inc\\BSP_DWT.h" 1
# 24 "../User/Bsp/inc\\BSP_DWT.h"
# 1 "../Core/Inc\\main.h" 1
# 30 "../Core/Inc\\main.h"
...
# 11 "../User/Bsp/ws2812.c" 2
uint16_t ws2812_buf[(24 * 6 + 50)];
uint8_t colors_white[6][3] = {
    {220, 220, 220},
    {220, 220, 220},
    {220, 220, 220},
    {220, 220, 220},
...
void ws2812_set_colors(uint8_t color_arr[][3])
{
    for(int led = 0; led < 6; led++) {
        ...
        for(int i = 0; i < 24; i++) {
            int idx = led * 24 + i;
            if (color & (1 << (23 - i))) {
                ws2812_buf[idx] = (209 * 0.67);
            } else {
                ws2812_buf[idx] = (209 * 0.33);
            }
        }
    }

    for(int i = 6 * 24; i < (24 * 6 + 50); i++) {
        ws2812_buf[i] = 0;
    }
HAL_TIM_PWM_Start_DMA(&htim8, 0x00000000U, (uint32_t*)ws2812_buf, (24 * 6 + 50));
}
void ws2812_double_flash_loop_param(const uint8_t colors_on[][3], const uint8_t colors_off[][3])
{
    ...
    uint32_t short_delay = 150;
    uint32_t long_delay = 1000;
