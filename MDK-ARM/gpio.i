...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)), ((uint16_t)0x1000)|((uint16_t)0x0800)|((uint16_t)0x0400), GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x1000)|((uint16_t)0x0800)|((uint16_t)0x0400);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x0UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)), &GPIO_InitStruct);
