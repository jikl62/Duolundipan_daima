...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../USB_DEVICE/App/usbd_desc.c" 2
...
# 23 "../USB_DEVICE/App/usbd_desc.c" 2
# 1 "../USB_DEVICE/App/usbd_desc.h" 1
# 107 "../USB_DEVICE/App/usbd_desc.h"
extern USBD_DescriptorsTypeDef FS_Desc;
# 24 "../USB_DEVICE/App/usbd_desc.c" 2
# 105 "../USB_DEVICE/App/usbd_desc.c"
static void Get_SerialNum(void);
static void IntToUnicode(uint32_t value, uint8_t * pbuf, uint8_t len);
# 117 "../USB_DEVICE/App/usbd_desc.c"
...
# 137 "../USB_DEVICE/App/usbd_desc.c"
...
, USBD_FS_InterfaceStrDescriptor
              ...
              uint8_t USBD_FS_DeviceDesc[0x12U] __attribute__ ((aligned (4))) =
{
  0x12,
  0x01U,
...
# 221 "../USB_DEVICE/App/usbd_desc.c"
              uint8_t USBD_LangIDDesc[0x04U] __attribute__ ((aligned (4))) =
{
     0x04U,
     0x03U,
     ...
     ((uint8_t)(((1033) & 0xFF00U) >> 8U))
              ...
              uint8_t USBD_StrDesc[512U] __attribute__ ((aligned (4)));




              uint8_t USBD_StringSerial[0x1A] __attribute__ ((aligned (4))) = {
  0x1A,
  0x03U,
};
...
# 388 "../USB_DEVICE/App/usbd_desc.c"
static void Get_SerialNum(void)
{
...
# 414 "../USB_DEVICE/App/usbd_desc.c"
static void IntToUnicode(uint32_t value, uint8_t * pbuf, uint8_t len)
{
  uint8_t idx = 0;
