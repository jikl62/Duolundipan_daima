# 1 "../User/Start/All_Init.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Start/All_Init.c" 2
# 33 "../User/Start/All_Init.c"
 ...
 flag2 = CANSPI_Initialize(&hspi2);
  ...
  HAL_TIM_Base_Start_IT(&htim1);
   HAL_TIM_Base_Start_IT(&htim3);
    HAL_TIM_PWM_Start(&htim8, 0x00000000U);
    ...
    HAL_UARTEx_ReceiveToIdle_DMA(&huart1, (uint8_t *)VT13_RX_DATA,sizeof(VT13_RX_DATA));
  (((((uint32_t)(0x1UL << (3U)))) != 0x00000080U)? ((huart1.hdmarx)->Instance->CR &= ~(((uint32_t)(0x1UL << (3U))))) : ((huart1.hdmarx)->Instance->FCR &= ~(((uint32_t)(0x1UL << (3U))))));

    HAL_DMA_DeInit(&hdma_usart3_rx);
    HAL_DMA_Init(&hdma_usart3_rx);
    HAL_UART_DMAStop(&huart3);
 ((((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 1U)? ((&huart3)->Instance->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 2U)? ((&huart3)->Instance->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): ((&huart3)->Instance->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)));
    ...
    HAL_UARTEx_ReceiveToIdle_DMA(&huart6,Referee_Rx_Buf[0],256);
  (((((uint32_t)(0x1UL << (3U)))) != 0x00000080U)? ((huart6.hdmarx)->Instance->CR &= ~(((uint32_t)(0x1UL << (3U))))) : ((huart6.hdmarx)->Instance->FCR &= ~(((uint32_t)(0x1UL << (3U))))));
   ...
   MX_USB_DEVICE_Init();
    ...
    ((TIM_TypeDef *) (0x40000000UL + 0x0800UL))->CCR3 = 50;
    HAL_Delay(500);
    ((TIM_TypeDef *) (0x40000000UL + 0x0800UL))->CCR3 = 0;
...
void StartDefaultTask(void const * argument)
{
 ...
 for(;;)
 {
  playSong_jiaofu();
        cnt++;
        SEGGER_RTT_printf(0,"  %s%s""Hello world: %d""\r\n%s", "\x1B[1;32m", "I: ", cnt, "\x1B[0m");
        SEGGER_RTT_printf(0,"  %s%s""This is an error message!""\r\n%s", "\x1B[1;31m", "E: ", "\x1B[0m");
        SEGGER_RTT_printf(0,"  %s%s""This is a warning message!""\r\n%s", "\x1B[1;33m", "W: ", "\x1B[0m");
  osDelay(1);
 }
}
