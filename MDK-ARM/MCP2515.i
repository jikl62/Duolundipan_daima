# 1 "../User/Bsp/MCP2515.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/MCP2515.c" 2
# 23 "../User/Bsp/MCP2515.c"
# 1 "../User/Bsp/inc\\MCP2515.h" 1
# 26 "../User/Bsp/inc\\MCP2515.h"
# 1 "../Core/Inc\\spi.h" 1
# 29 "../Core/Inc\\spi.h"
# 1 "../Core/Inc/main.h" 1
# 30 "../Core/Inc/main.h"
...
# 24 "../User/Bsp/MCP2515.c" 2
# 1 "../Core/Inc\\gpio.h" 1
# 39 "../Core/Inc\\gpio.h"
void MX_GPIO_Init(void);
# 25 "../User/Bsp/MCP2515.c" 2
...
_Bool MCP2515_SetConfigMode(SPI_HandleTypeDef *hspi)
{
  ...
  MCP2515_WriteByte(hspi, 0x0F, 0x80);

  uint8_t loop = 10;

  do {

    if((MCP2515_ReadByte(hspi, 0x0E) & 0xE0) == 0x80)
      return 1;
...
_Bool MCP2515_SetNormalMode(SPI_HandleTypeDef *hspi)
{
  ...
  MCP2515_WriteByte(hspi, 0x0F, 0x00);

  uint8_t loop = 10;

  do {

    if((MCP2515_ReadByte(hspi, 0x0E) & 0xE0) == 0x00)
      return 1;
...
_Bool MCP2515_SetSleepMode(SPI_HandleTypeDef *hspi)
{
  ...
  MCP2515_WriteByte(hspi, 0x0F, 0x20);

  uint8_t loop = 10;

  do {

    if((MCP2515_ReadByte(hspi, 0x0E) & 0xE0) == 0x20)
      return 1;
...
static void SPI_TxBuffer(SPI_HandleTypeDef *hspi, uint8_t *buffer, uint8_t length)
{
  HAL_SPI_Transmit(hspi, buffer, length, 10);
}
...
{
  uint8_t retVal;
  HAL_SPI_Receive(hspi, &retVal, 1, 10);
  return retVal;
}
