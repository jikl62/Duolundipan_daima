...
void MX_TIM4_Init(void)
{
  ...
  if (HAL_TIM_PWM_ConfigChannel(&htim4, &sConfigOC, 0x00000008U) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_TIM8_Init(void)
{
  ...
  htim8.Instance = ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL));
  htim8.Init.Prescaler = 0;
  htim8.Init.CounterMode = 0x00000000U;
  htim8.Init.Period = 209;
  htim8.Init.ClockDivision = 0x00000000U;
  htim8.Init.RepetitionCounter = 0;
  htim8.Init.AutoReloadPreload = 0x00000000U;
  ...
  if (HAL_TIM_PWM_ConfigChannel(&htim8, &sConfigOC, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_TIM10_Init(void)
{
  ...
  htim10.Instance = ((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x4400UL));
  htim10.Init.Prescaler = 84-1;
  htim10.Init.CounterMode = 0x00000000U;
  htim10.Init.Period = 2000-1;
  htim10.Init.ClockDivision = 0x00000000U;
  htim10.Init.AutoReloadPreload = 0x00000000U;
  ...
  sConfigOC.OCPolarity = 0x00000000U;
  sConfigOC.OCFastMode = 0x00000000U;
  if (HAL_TIM_PWM_ConfigChannel(&htim10, &sConfigOC, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0800UL)))
  {
    ...
    hdma_tim4_ch3.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x0B8UL));
    hdma_tim4_ch3.Init.Channel = 0x04000000U;
    hdma_tim4_ch3.Init.Direction = 0x00000000U;
    hdma_tim4_ch3.Init.PeriphInc = 0x00000000U;
    hdma_tim4_ch3.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_tim4_ch3.Init.PeriphDataAlignment = ((uint32_t)(0x1UL << (11U)));
    hdma_tim4_ch3.Init.MemDataAlignment = ((uint32_t)(0x1UL << (13U)));
    hdma_tim4_ch3.Init.Mode = 0x00000000U;
    hdma_tim4_ch3.Init.Priority = 0x00000000U;
    hdma_tim4_ch3.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_tim4_ch3) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (tim_baseHandle)->hdma[((uint16_t) 0x0003)] = &(hdma_tim4_ch3); (hdma_tim4_ch3).Parent = (tim_baseHandle); } while(0U);




  }
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x1400UL)))
  {




    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (5U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (5U)))); (void)tmpreg; } while(0U);
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)))
  {
    ...
    hdma_tim8_ch1.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x040UL));
    hdma_tim8_ch1.Init.Channel = 0x0E000000U;
    hdma_tim8_ch1.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_tim8_ch1.Init.PeriphInc = 0x00000000U;
    hdma_tim8_ch1.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_tim8_ch1.Init.PeriphDataAlignment = ((uint32_t)(0x1UL << (11U)));
    hdma_tim8_ch1.Init.MemDataAlignment = ((uint32_t)(0x1UL << (13U)));
    hdma_tim8_ch1.Init.Mode = ((uint32_t)(0x1UL << (8U)));
    hdma_tim8_ch1.Init.Priority = 0x00000000U;
    hdma_tim8_ch1.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_tim8_ch1) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (tim_baseHandle)->hdma[((uint16_t) 0x0001)] = &(hdma_tim8_ch1); (hdma_tim8_ch1).Parent = (tim_baseHandle); } while(0U);




  }
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x4400UL)))
  {
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  if(timHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0800UL)))
  {
  ...
  else if(timHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)))
  {
    ...
    GPIO_InitStruct.Alternate = ((uint8_t)0x03);
  ...
  else if(timHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x4400UL)))
  {
...
# 534 "../Core/Src/tim.c"
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0800UL)))
  {
    ...
    HAL_DMA_DeInit(tim_baseHandle->hdma[((uint16_t) 0x0003)]);
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x1400UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (5U))));
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0400UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~((0x1UL << (1U))));


    HAL_DMA_DeInit(tim_baseHandle->hdma[((uint16_t) 0x0001)]);
