# 1 "../User/App/Chassis_Task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/App/Chassis_Task.c" 2
...
# 5 "../User/App/inc\\Chassis_Task.h" 2
...
# 6 "../User/App/inc\\Chassis_Task.h" 2
...
# 7 "../User/App/inc\\Chassis_Task.h" 2
...
# 9 "../User/App/inc\\Chassis_Task.h" 2
...
uint8_t Chassis_AIM_INIT(RUI_ROOT_STATUS_Typedef *Root, MOTOR_Typdef *MOTOR)
{
    ...
    if (Root->MOTOR_Chassis_1 == 0 ||
        Root->MOTOR_Chassis_2 == 0 ||
        Root->MOTOR_Chassis_3 == 0 ||
        Root->MOTOR_Chassis_4 == 0)
        return 0;
