...
# 43 "../Core/Src/spi.c"
  ...
  hspi1.Init.CLKPolarity = (0x1UL << (1U));
  hspi1.Init.CLKPhase = (0x1UL << (0U));
...
{
# 75 "../Core/Src/spi.c"
  hspi2.Instance = ((SPI_TypeDef *) (0x40000000UL + 0x3800UL));
  hspi2.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
  hspi2.Init.Direction = (0x00000000U);
  hspi2.Init.DataSize = (0x00000000U);
  hspi2.Init.CLKPolarity = (0x00000000U);
  hspi2.Init.CLKPhase = (0x00000000U);
  hspi2.Init.NSS = (0x1UL << (9U));
  hspi2.Init.BaudRatePrescaler = ((0x2UL << (3U)));
  hspi2.Init.FirstBit = (0x00000000U);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  if(spiHandle->Instance==((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0010)|((uint16_t)0x0008);
    ...
    hdma_spi1_rx.Init.Priority = ((uint32_t)(0x3UL << (16U)));
    ...
    do{ (spiHandle)->hdmarx = &(hdma_spi1_rx); (hdma_spi1_rx).Parent = (spiHandle); } while(0U);
    ...
    hdma_spi1_tx.Init.Priority = ((uint32_t)(0x2UL << (16U)));
    ...
    do{ (spiHandle)->hdmatx = &(hdma_spi1_tx); (hdma_spi1_tx).Parent = (spiHandle); } while(0U);




  }
  else if(spiHandle->Instance==((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  if(spiHandle->Instance==((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0010)|((uint16_t)0x0008));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0080));
  ...
  else if(spiHandle->Instance==((SPI_TypeDef *) (0x40000000UL + 0x3800UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000));
