# 1 "../User/Bsp/bsp_buzzer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/bsp_buzzer.c" 2
# 1 "../User/Bsp/inc\\bsp_buzzer.h" 1
...
# 5 "../User/Bsp/inc\\bsp_buzzer.h" 2

void BSP_Buzzer_Init(void);
void BSP_Buzzer_On(void);
void BSP_Buzzer_Off(void);
void BSP_Buzzer_Toggle(void);
# 2 "../User/Bsp/bsp_buzzer.c" 2

static uint8_t buzzerSta = 0;

void BSP_Buzzer_Init(void)
{
    HAL_TIM_PWM_Start(&htim4, 0x00000008U);
}
