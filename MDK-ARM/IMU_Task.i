# 1 "../User/App/IMU_Task.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/App/IMU_Task.c" 2
...
# 89 "../Middlewares/CMSIS/DSP/Inc\\arm_math_types.h"
...
# 2 "../User/App/IMU_Task.c" 2
# 12 "../User/App/IMU_Task.c"
void IMU_Temperature_Ctrl(IMU_Data_t *IMU, pid_type_def *imu_temp_pid)
{
 uint16_t tempPWM;

 PID_calc(imu_temp_pid, IMU->temp, 40.f);
...
void INS_Task(IMU_Data_t *IMU, pid_type_def *imu_temp_pid)
{
   ...
   memcpy(IMU->q, QEKF_INS.q, 16);
        ...
        else if(IMU->attitude_flag==1)
        {
# 78 "../User/App/IMU_Task.c"
