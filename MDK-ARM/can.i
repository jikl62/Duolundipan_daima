...
# 41 "../Core/Src/can.c"
  ...
  hcan1.Init.TimeSeg1 = ((uint32_t)((0x8UL << (16U)) | (0x1UL << (16U))));
  hcan1.Init.TimeSeg2 = ((uint32_t)(0x2UL << (20U)));
...
{
# 73 "../Core/Src/can.c"
  hcan2.Instance = ((CAN_TypeDef *) (0x40000000UL + 0x6800UL));
  hcan2.Init.Prescaler = 3;
  hcan2.Init.Mode = (0x00000000U);
  hcan2.Init.SyncJumpWidth = (0x00000000U);
  hcan2.Init.TimeSeg1 = ((uint32_t)((0x8UL << (16U)) | (0x1UL << (16U))));
  hcan2.Init.TimeSeg2 = ((uint32_t)(0x2UL << (20U)));
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* canHandle)
{
  ...
  if(canHandle->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6400UL)))
  {
  ...
  else if(canHandle->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6800UL)))
  {




    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (26U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (26U)))); (void)tmpreg; } while(0U);
    HAL_RCC_CAN1_CLK_ENABLED++;
    if(HAL_RCC_CAN1_CLK_ENABLED==1){
      do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (25U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (25U)))); (void)tmpreg; } while(0U);
    }
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* canHandle)
{
  ...
  else if(canHandle->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6800UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (26U))));
    HAL_RCC_CAN1_CLK_ENABLED--;
    if(HAL_RCC_CAN1_CLK_ENABLED==0){
      (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (25U))));
    }
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0020)|((uint16_t)0x0040));
