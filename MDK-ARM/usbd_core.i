...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 2
# 20 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
# 1 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_core.h" 1
# 28 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_core.h"
# 1 "../USB_DEVICE/Target\\usbd_conf.h" 1
# 30 "../USB_DEVICE/Target\\usbd_conf.h"
# 1 "D:\\kevil\\ARM\\ARMCLANG\\Bin\\..\\include\\stdio.h" 1 3
# 53 "D:\\kevil\\ARM\\ARMCLANG\\Bin\\..\\include\\stdio.h" 3
...
# 34 "../USB_DEVICE/Target\\usbd_conf.h" 2
# 153 "../USB_DEVICE/Target\\usbd_conf.h"
void *USBD_static_malloc(uint32_t size);
void USBD_static_free(void *p);
# 29 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_core.h" 2
...
# 30 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc\\usbd_core.h" 2
...
# 21 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c" 2
# 92 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
USBD_StatusTypeDef USBD_RunTestMode(USBD_HandleTypeDef *pdev)
{
# 451 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  (void)pdev;
...
# 586 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  ...
  if (epnum == 0U)
  {
    ...
    if (pdev->ep0_state == 0x03U)
    {
      if (pep->rem_length > pep->maxpacket)
      {
        ...
        (void)USBD_CtlContinueRx(pdev, pep->pbuffer, (((pep->rem_length) > (pep->maxpacket)) ? (pep->rem_length) : (pep->maxpacket)));
      }
      else
      {
...
# 684 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
USBD_StatusTypeDef USBD_LL_Reset(USBD_HandleTypeDef *pdev)
{
  ...
  pdev->dev_test_mode = 0U;
# 812 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  if (pdev->pClass[0] != 0)
  {
...
# 936 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
# 962 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
USBD_StatusTypeDef USBD_LL_DevDisconnected(USBD_HandleTypeDef *pdev)
{
  ...
  pdev->dev_state = 0x01U;
# 1027 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  if (pdev->pClass[0] != 0)
  {
...
# 1046 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
uint8_t USBD_CoreFindIF(USBD_HandleTypeDef *pdev, uint8_t index)
{
# 1072 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  (void)pdev;
  (void)index;
...
# 1086 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
uint8_t USBD_CoreFindEP(USBD_HandleTypeDef *pdev, uint8_t index)
{
# 1112 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  (void)pdev;
  (void)index;
...
# 1157 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
void *USBD_GetEpDesc(uint8_t *pConfDesc, uint8_t EpAddr)
{
...
# 1198 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
USBD_DescHeaderTypeDef *USBD_GetNextDesc(uint8_t *pbuf, uint16_t *ptr)
{
