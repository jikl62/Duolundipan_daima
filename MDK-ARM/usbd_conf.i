# 1 "../USB_DEVICE/Target/usbd_conf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../USB_DEVICE/Target/usbd_conf.c" 2
# 22 "../USB_DEVICE/Target/usbd_conf.c"
...
# 28 "../Drivers/STM32F4xx_HAL_Driver/Inc/stm32f4xx_ll_adc.h"
# 1 "../Drivers/CMSIS/Device/ST/STM32F4xx/Include\\stm32f4xx.h" 1
# 29 "../Drivers/STM32F4xx_HAL_Driver/Inc/stm32f4xx_ll_adc.h" 2
...
# 23 "../USB_DEVICE/Target/usbd_conf.c" 2
...
# 25 "../USB_DEVICE/Target/usbd_conf.c" 2
...
# 26 "../USB_DEVICE/Target/usbd_conf.c" 2
...
# 28 "../USB_DEVICE/Target/usbd_conf.c" 2
# 42 "../USB_DEVICE/Target/usbd_conf.c"
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  if(pcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x50000000UL))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x1000)|((uint16_t)0x0800);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  if(pcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x50000000UL))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x1000)|((uint16_t)0x0800));
...
# 135 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_SetupStageCallback(PCD_HandleTypeDef *hpcd)

{
  USBD_LL_SetupStage((USBD_HandleTypeDef*)hpcd->pData, (uint8_t *)hpcd->Setup);
}
# 150 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_DataOutStageCallback(PCD_HandleTypeDef *hpcd, uint8_t epnum)

{
  USBD_LL_DataOutStage((USBD_HandleTypeDef*)hpcd->pData, epnum, hpcd->OUT_ep[epnum].xfer_buff);
}
# 165 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_DataInStageCallback(PCD_HandleTypeDef *hpcd, uint8_t epnum)

{
  USBD_LL_DataInStage((USBD_HandleTypeDef*)hpcd->pData, epnum, hpcd->IN_ep[epnum].xfer_buff);
}
# 179 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_SOFCallback(PCD_HandleTypeDef *hpcd)
...
# 226 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_SuspendCallback(PCD_HandleTypeDef *hpcd)
...
# 269 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_ISOOUTIncompleteCallback(PCD_HandleTypeDef *hpcd, uint8_t epnum)
...
# 312 "../USB_DEVICE/Target/usbd_conf.c"
void HAL_PCD_DisconnectCallback(PCD_HandleTypeDef *hpcd)

{
  USBD_LL_DevDisconnected((USBD_HandleTypeDef*)hpcd->pData);
}
# 327 "../USB_DEVICE/Target/usbd_conf.c"
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  hpcd_USB_OTG_FS.Init.phy_itface = 2U;
...
# 581 "../USB_DEVICE/Target/usbd_conf.c"
