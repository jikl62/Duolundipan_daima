...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c" 2
...
# 259 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c" 2
...
HAL_StatusTypeDef HAL_LIN_SendBreak(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = (uint32_t)__builtin_arm_ldrex((volatile uint32_t *)&(huart->Instance->CR1)) | ((0x1UL << (0U))); } while (((uint32_t)__builtin_arm_strex(val,(volatile uint32_t *)&(huart->Instance->CR1))) != 0U); } while(0);
                                                     ...
                                                     uint32_t Tickstart, uint32_t Timeout)
{
  ...
  while (((((huart)->Instance->SR & (Flag)) == (Flag)) ? SET : RESET) == Status)
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      ...
      if ((((huart->Instance->CR1) & ((0x1UL << (2U)))) != 0U) && (Flag != ((uint32_t)(0x1UL << (7U)))) && (Flag != ((uint32_t)(0x1UL << (6U)))))
      {
        if ((((huart)->Instance->SR & (((uint32_t)(0x1UL << (3U))))) == (((uint32_t)(0x1UL << (3U))))) == SET)
        {
...
static HAL_StatusTypeDef UART_Receive_IT(UART_HandleTypeDef *huart)
{
  uint8_t *pdata8bits = 0;
  uint16_t *pdata16bits = 0;
...
# 3770 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
