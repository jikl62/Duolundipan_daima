# 1 "../User/Bsp/RGBctrl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 388 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../User/Bsp/RGBctrl.c" 2
...
# 5 "../User/Bsp/inc\\RGBctrl.h" 2

void RUI_F_LED(uint8_t COLOR , int TIME);
# 2 "../User/Bsp/RGBctrl.c" 2
...
void RUI_F_LED(uint8_t COLOR , int TIME)
{
 static uint32_t TIME_LAST = 0;
    ...
    static GPIO_TypeDef* LED_PORT[3] ={ ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)), ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)), ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL)) };

    static uint16_t LED_PIN[3] ={ ((uint16_t)0x1000), ((uint16_t)0x0800), ((uint16_t)0x0400) };
