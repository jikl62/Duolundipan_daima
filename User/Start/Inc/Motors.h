...
{   
    ...
    DJI_MOTOR_Typedef DJI_6020_Chassis;
    DM_MOTOR_Typdef DM_3507_Yaw;

    DJI_MOTOR_Typedef DJI_6020_Chassis_duo_0;

    DJI_MOTOR_Typedef DJI_6020_Chassis_FL;  /* 左前，ID 1，反馈0x205 */
    DJI_MOTOR_Typedef DJI_6020_Chassis_FR;  /* 右前，ID 2，反馈0x206 */
    DJI_MOTOR_Typedef DJI_6020_Chassis_RL;  /* 左后，ID 3，反馈0x207 */
    DJI_MOTOR_Typedef DJI_6020_Chassis_RR;  /* 右后，ID 4，反馈0x208 */
